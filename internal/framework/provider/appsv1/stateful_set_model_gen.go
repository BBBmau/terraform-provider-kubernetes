...
type StatefulSetModel struct {
	...
	Spec struct {
		...
		Ordinals        struct {
			Start types.Int64 `tfsdk:"start" manifest:"start"`
		} `tfsdk:"ordinals" manifest:"ordinals"`
		PersistentVolumeClaimRetentionPolicy struct {
			WhenDeleted types.String `tfsdk:"when_deleted" manifest:"whenDeleted"`
			WhenScaled  types.String `tfsdk:"when_scaled" manifest:"whenScaled"`
		} `tfsdk:"persistent_volume_claim_retention_policy" manifest:"persistentVolumeClaimRetentionPolicy"`
		PodManagementPolicy  types.String `tfsdk:"pod_management_policy" manifest:"podManagementPolicy"`
		...
		ServiceName types.String `tfsdk:"service_name" manifest:"serviceName"`
		Template    struct {
			Metadata struct {
				Annotations                map[string]types.String `tfsdk:"annotations" manifest:"annotations"`
		...
		UpdateStrategy struct {
			...
			Type types.String `tfsdk:"type" manifest:"type"`
		} `tfsdk:"update_strategy" manifest:"updateStrategy"`
		VolumeClaimTemplates []struct {
			...
			Status struct {
				AccessModes               []types.String          `tfsdk:"access_modes" manifest:"accessModes"`
				AllocatedResourceStatuses map[string]types.String `tfsdk:"allocated_resource_statuses" manifest:"allocatedResourceStatuses"`
				AllocatedResources        map[string]types.String `tfsdk:"allocated_resources" manifest:"allocatedResources"`
				Capacity                  map[string]types.String `tfsdk:"capacity" manifest:"capacity"`
				Conditions                []struct {
					LastProbeTime      types.String `tfsdk:"last_probe_time" manifest:"lastProbeTime"`
				...
				Phase types.String `tfsdk:"phase" manifest:"phase"`
			} `tfsdk:"status" manifest:"status"`
		} `tfsdk:"volume_claim_templates" manifest:"volumeClaimTemplates"`
	} `tfsdk:"spec" manifest:"spec"`
	Status struct {
		AvailableReplicas types.Int64 `tfsdk:"available_replicas" manifest:"availableReplicas"`
		CollisionCount    types.Int64 `tfsdk:"collision_count" manifest:"collisionCount"`
		Conditions        []struct {
			LastTransitionTime types.String `tfsdk:"last_transition_time" manifest:"lastTransitionTime"`
			Message            types.String `tfsdk:"message" manifest:"message"`
			Reason             types.String `tfsdk:"reason" manifest:"reason"`
		...
		CurrentReplicas    types.Int64  `tfsdk:"current_replicas" manifest:"currentReplicas"`
		CurrentRevision    types.String `tfsdk:"current_revision" manifest:"currentRevision"`
		ObservedGeneration types.Int64  `tfsdk:"observed_generation" manifest:"observedGeneration"`
		ReadyReplicas      types.Int64  `tfsdk:"ready_replicas" manifest:"readyReplicas"`
		Replicas           types.Int64  `tfsdk:"replicas" manifest:"replicas"`
		UpdateRevision     types.String `tfsdk:"update_revision" manifest:"updateRevision"`
		UpdatedReplicas    types.Int64  `tfsdk:"updated_replicas" manifest:"updatedReplicas"`
	} `tfsdk:"status" manifest:"status"`
}
