...
func (r *StatefulSet) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var dataModel StatefulSetModel
...
func (r *StatefulSet) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var dataModel StatefulSetModel
...
func (r *StatefulSet) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var dataModel StatefulSetModel
...
func (r *StatefulSet) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
...
func (r *StatefulSet) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
