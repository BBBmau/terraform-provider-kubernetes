...
func (r *Deployment) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
...
Optional: true,
    ...
    "template": schema.SingleNestedAttribute{ 
        MarkdownDescription: `Template describes the pods that will be created. The only allowed template.spec.restartPolicy value is "Always".`,
Optional: true,
  Attributes: map[string]schema.Attribute{
    "metadata": schema.SingleNestedAttribute{ 
        MarkdownDescription: `Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata`,
...
Optional: true,
    ...
    "ready_replicas": schema.Int64Attribute{ 
        MarkdownDescription: `readyReplicas is the number of pods targeted by this Deployment with a Ready Condition.`,
Optional: true,
