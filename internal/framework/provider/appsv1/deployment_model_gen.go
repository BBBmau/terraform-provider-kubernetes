...
type DeploymentModel struct {
	...
	Status struct {
		...
		Conditions        []struct {
			...
			LastUpdateTime     types.String `tfsdk:"last_update_time" manifest:"lastUpdateTime"`
		...
		Replicas            types.Int64 `tfsdk:"replicas" manifest:"replicas"`
		UnavailableReplicas types.Int64 `tfsdk:"unavailable_replicas" manifest:"unavailableReplicas"`
