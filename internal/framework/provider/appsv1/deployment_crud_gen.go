...
func (r *Deployment) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var dataModel DeploymentModel
...
func (r *Deployment) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var dataModel DeploymentModel
...
func (r *Deployment) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var dataModel DeploymentModel
...
func (r *Deployment) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
...
func (r *Deployment) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
